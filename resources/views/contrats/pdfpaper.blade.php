...
<table id="table">
    ...
    <tr>
        ...
        <td style="border: 1px solid rgb(146, 142, 142);">
            Type / النوع
            <p id="mp">
                &emsp;&emsp;&nbsp; {{ $vehicule($contrat->vehicule_matricule)->type }} &nbsp;
            </p>
        </td>
        <td style="border: 1px solid rgb(146, 142, 142);">
            Immatriculation/الرقم المنجمي
            <p id="mp">
                &emsp;&emsp;&nbsp; {{ $contrat->vehicule_matricule }} &nbsp;
            </p>
        </td>
    </tr>
    <tr>
        ...
        <td style="border: 1px solid rgb(146, 142, 142);">
            Livraison / التسليم
            <p id="mp">
                &emsp;&emsp;&nbsp; {{ $contrat->livraison }} &nbsp;
            </p>
        </td>
        <td style="border: 1px solid rgb(146, 142, 142);">
            Reprise / استرجاع
            <p id="mp">
                &emsp;&emsp;&nbsp; {{ $contrat->reprise }} &nbsp;
            </p>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="4">
            <table id="tableic">
                <tr>
                    <td rowspan="7" colspan="1" style="text-align: center">
                    ...
                    <td>
                        <input type="checkbox" id="tapis" name="tapis" onclick="return false;"
                            {{ $checkOut($contrat->id)->tapis == 1 ? 'checked="checked"' : '' }}>
                ...
                <tr>
                    <td>
                        <input type="checkbox" id="attestAssurance" name="attestAssurance" onclick="return false;"
                            {{ $checkOut($contrat->id)->attestAssurance == 1 ? 'checked="checked"' : '' }}>
                    ...
                    <td>
                        <input type="checkbox" id="cric" name="cric" onclick="return false;"
                            {{ $checkOut($contrat->id)->cric == 1 ? 'checked="checked"' : '' }}>
                ...
                <tr>
                    <td>
                        <input type="checkbox" id="carteExploitation" name="carteExploitation" onclick="return false;"
                            {{ $checkOut($contrat->id)->carteExploitation == 1 ? 'checked="checked"' : '' }}>
                    ...
                    <td>
                        <input type="checkbox" id="enjoliveur" name="enjoliveur" onclick="return false;"
                            {{ $checkOut($contrat->id)->enjoliveur == 1 ? 'checked="checked"' : '' }}>
                ...
                <tr>
                    <td>
                        <input type="checkbox" id="visiteTechnique" name="visiteTechnique" onclick="return false;"
                            {{ $checkOut($contrat->id)->visiteTechnique == 1 ? 'checked="checked"' : '' }}>
                    ...
                    <td>
                        <input type="checkbox" id="allumeCigar" name="allumeCigar" onclick="return false;"
                            {{ $checkOut($contrat->id)->allumeCigar == 1 ? 'checked="checked"' : '' }}>
                ...
                <tr>
                    <td>
                        <input type="checkbox" id="roueSecours" name="roueSecours" onclick="return false;"
                            {{ $checkOut($contrat->id)->roueSecours == 1 ? 'checked="checked"' : '' }}>
                    ...
                    <td>
                        <input type="checkbox" id="trianglePanne" name="trianglePanne" onclick="return false;"
                            {{ $checkOut($contrat->id)->trianglePanne == 1 ? 'checked="checked"' : '' }}>
                ...
                <tr>
                    <td>
                        <input type="checkbox" id="lecteurCd" name="lecteurCd" onclick="return false;"
                            {{ $checkOut($contrat->id)->lecteurCd == 1 ? 'checked="checked"' : '' }}>
                    ...
                    <td>
                        <input type="checkbox" id="autre" name="autre" onclick="return false;"
                            {{ $checkOut($contrat->id)->autre == 1 ? 'checked="checked"' : '' }}>
    ...
    <tr>
        <td colspan="4">
            <table id="tableie">
                <tr>
                    <td valign="top">
                        J'accuse réception du véhicule susmentionné et
                        accepte qu'il me soit loué aux conditions fixées en
                        page 1 et 2. Je reconnais que le véhicule m'est remis
                        tel que mentionné ci-dessus et que le franchise pour
                        dommages à ma charge est de 1000DT à moins que je
                        n'accepte de payer le supplément pour supprimer la
                        franchise en apposant mes initiales ci-dessus.
                        <p style="text-align: right; margin-top: 0px;">
                            أعترف بتسليم السيارة المذكورة أعلاه. واقبل بكل الشروط المذكورة في
                            الصفحة الأولى والثانية واعترف بتسليمي السيارة في الحالة المذكورة
                            أعلاه وان قيمة القسط المحمول على كاهل المؤمن له 5% من قيمة
                            السيارة والتزم بذلك.
                        </p>
                    </td>
                    <td valign="top">
