@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'loginAdmin', 'title' => __('Material Dashboard')])
...
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    ...
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ url('login/admin') }}">
        @csrf
          ...
          <div class="card-body">
            ...
            <div class="bmd-form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
              <div class="input-group">
                ...
                <input type="email" name="email" class="form-control" placeholder="{{ __('Email...') }}" value="{{ old('email', 'madmin@sglv.com') }}" required>
              </div>
              @if ($errors->has('email'))
