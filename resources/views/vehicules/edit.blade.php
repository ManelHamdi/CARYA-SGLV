         ...
         <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="matricule" value="{{ $vehicule->matricule }}" class="form-control" placeholder="Matricule">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Image:</strong>
                    <input type="text" name="type" value="{{ $vehicule->type }}" class="form-control" placeholder="Type">
                </div>
            </div>
