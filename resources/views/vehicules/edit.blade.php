                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="couleur" value="{{ $vehicule->couleur }}"
                                                    list="couleur" class="form-control" placeholder="Couleur">
                                                <datalist id="couleur">
                                                    <option value="#FFFFFF">
                                                    <option value="#000000">
                                                    <option value="#808080">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="carburation" id="carburation" class="form-control">
                                                    <option value="essence" {{ ($vehicule->carburation == 'essence') ? 'selected' : '' }}>essence</option>
                                                    <option value="GPL" {{ ($vehicule->carburation == 'GPL') ? 'selected' : '' }}>GPL</option>
                                                    <option value="diesel" {{ ($vehicule->carburation == 'diesel') ? 'selected' : '' }}>diesel</option>
                                                </select>
                                            </div>
                                        </div>
                                    </td>
